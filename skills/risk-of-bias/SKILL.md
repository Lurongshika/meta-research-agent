---
name: risk-of-bias
description: Assess and document study quality using RoB 2, ROBINS-I, Newcastle-Ottawa Scale, QUADAS-2, and related frameworks.
---
...
Base every judgment on text actually available from the study report, protocol, registry, or supplement. Do not infer a low-risk judgment from missing information. Treat upstream R/MCP tool names as workflow concepts, not guaranteed callable tools, and distinguish human-review recommendations from completed assessments.
